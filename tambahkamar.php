...
<body>
    ...
    <div class="content">
        ...
        <form action="proseskamar.php" method="POST">
            Nomor Kamar: <input type="text" name="nomor_kamar" id=""><br>
            Tipe Kamar: <select name="tipe_kamar" id="">
                <option value="1">Single</option>
                <option value="2">Double</option>
            </select><br>
            Harga per Malam: <input type="text" name="harga_per_malam" id=""><br>
            <input type="submit" value="Simpan Kamar">
